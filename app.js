...
fs.readdirSync(path.join(__dirname, 'routes')).reverse().forEach(file => {
  ...
  app.use(`/${filename}`, (req, res, next) => {
    `ts_uid=7230012975; tvfe_boss_uuid=3fe8afd0640fa5b0; uin=956581739; yq_index=0; pgv_pvid=2796982635; RK=tHhAJrF5O0; ptcz=392dde7db8d973728b39edc013f69ba627abe2ac759c1e667d91520ca58545c7; psrf_qqopenid=239ACC14853AA1038A3A539429D0AC48; psrf_qqaccess_token=6B0C62126368CA1ACE16C932C679747D; psrf_qqrefresh_token=25BACF1650EE2592D06BCC19EEAD7AD6; psrf_qqunionid=B727DBE86225939A050C84A13D0A3A05; ts_refer=music.qq.com/; pgv_info=ssid=s2966589960; ptisp=ctc; psrf_musickey_createtime=1568876170; psrf_access_token_expiresAt=1576652170; qm_keyst=Q_H_L_2ee93s50eiPe0vl3j8dtFWZtYuWCgNYL5Vias3U1CluknJnnbzpgcdn95yqzsO3; a=b; yqq_stat=0; sd_userid=46411568944312468; sd_cookie_crttime=1568944312468; userAction=1`
      .split(' ').forEach((k) => {
